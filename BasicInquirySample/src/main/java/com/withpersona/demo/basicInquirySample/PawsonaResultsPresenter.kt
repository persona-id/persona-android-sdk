package com.withpersona.demo.basicInquirySample
...
import com.withpersona.demo.basicInquirySample.databinding.ActivityMainBinding
import com.withpersona.demo.basicInquirySample.databinding.ContentInquiryBinding
import com.withpersona.demo.basicInquirySample.databinding.ContentResultBinding
    ...
    fun showResults(title: String, values: List<Pair<String, InquiryField>>) {
        ...
        for ((label, value) in values) {
            ...
            val stringValue: String = when (value) {
                ...
                is InquiryField.ChoicesField -> value.value.toString()
                is InquiryField.MultiChoicesField -> value.value.toString()
